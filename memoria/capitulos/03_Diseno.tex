...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.95\textwidth]{../imagenes/uml_general.pdf}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.95\textwidth]{../imagenes/uml_math.pdf}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.95\textwidth]{../imagenes/uml_codec.pdf}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.95\textwidth]{../imagenes/uml_sim.pdf}
